function Chair() {
    ...
    const gsirt = new THREE.BoxGeometry(6,6,1);
	const msirt = new THREE.MeshBasicMaterial( { color: 0xff00ff } );
	const sirt = new THREE.Mesh( gsirt, msirt );
    
	sirt.position.set(0, 6, -3);
	chair.add( sirt );
